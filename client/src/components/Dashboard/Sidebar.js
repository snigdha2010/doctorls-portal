...
const Sidebar = () => {
    ...
    useEffect(() => {
        fetch('https://agile-retreat-07676.herokuapp.com/isDoctor', {
            method: 'POST',
    ...
    return (
        <div className="sidebar d-flex flex-column justify-content-between col-md-3 py-5 px-4" style={{ height: "100vh" }}>
            ...
            <div>
                <Link onClick={googleSignOut} to="/" className="text-white"><FontAwesomeIcon icon={faSignOutAlt} /> <span>Logout</span></Link>
            </div>
        </div>
    );
};
